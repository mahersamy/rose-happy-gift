...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/WehIL4FpJa)
...
```sh
npx nx serve rose-ecommerce
```

To create a production bundle:

```sh
npx nx build rose-ecommerce
```

To see all available targets to run for a project, run:

```sh
npx nx show project rose-ecommerce
```
